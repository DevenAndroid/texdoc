...
Future<ModelCommonResponse> createNewPassword(context, password, confirmPassword, phone) async {
  ...
  final response = await http.post(Uri.parse(ApiUrls.createNewPasswordApiUrl),
